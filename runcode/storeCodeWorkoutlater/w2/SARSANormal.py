...
if __name__ == "__main__":
    ...
    np.save("SARSA_Q", reward_rlog)
    np.save("SARSA_ha", hazard_rlog)
    np.save("SARSA_re", reward_rlog)
    ...
    # plt.show()
    f1.savefig('ha_count_normal_SARSA.png')
    ...
    # plt.show()
    f2.savefig('reward_normal_SARSA.png')
